...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div>
            <h1 style="text-align: center">Sửa Tòa Nhà</h1>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <form:form method="get" modelAttribute="buildingEdit" id="form-edit">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <form:input type="text" name="ward" id="ward" class="form-control" path="ward"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <form:input type="text" name="street" id="street" class="form-control" path="street"/>
                                </div>
                            </div>
...
<%--                            <!-- Kết cấu -->--%>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <form:input type="text" class="form-control" path="rentareaEntity_List"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <form:input type="text" name="rentPrice" id="rentPrice" class="form-control" path="rentPrice"/>
                                </div>
                            </div>
                            ...
                            <div class="row text-center">
                                <div class="col-xs-9 col-xs-offset-3">
                                    <button type="submit" class="btn btn-primary" id="btnAddorUpdateBuilding">
                                        ...
                                        Sửa Toà Nhà</button>
                                    <a href="/admin/building-list"><button type="button" class="btn btn-default" >Hủy Thao Tác</button></a>
