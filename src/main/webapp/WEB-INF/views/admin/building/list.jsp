...
<c:url var="formAjax" value="/api/buildings"/>
<html>
<head>
...
<body>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div style="background-color: #f5f5f5; padding: 20px; border-radius: 10px;">
                <div class="container">
                    <h3 class="text-center" style="color: #333; margin-bottom: 20px;">Tìm Kiếm Tòa Nhà</h3>
                            ...
                            <form:form modelAttribute="ModelSearch" action="/admin/building-list" method="GET" id="listform">
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-6">
                                        ...
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="Mời nhập tên toà nhà !!" path="name"/>
                                    </div>
                                    <div class="col-xs-6">
                                        <label for="">Diện Tích Sàn</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="0" path="floorarea"/>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-2">
                                        <label for="">Quận</label>
                                            <%--                                        <select name="district" class="form-control" style="border-radius: 5px;" >--%>
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="0" path="ward"/>
                                            <%--                                        <input type="text" name="ward" class="form-control" style="border-radius: 5px;" value="${ModelSearch.ward}" placeholder="Mời nhập Phường !!">--%>
                                    </div>
                                    <div class="col-xs-5">
                                        <label for="">Đường</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="Mời nhập tên Đường !!" path="street"/>
                                            <%--                                        <input type="text" name="street" class="form-control" style="border-radius: 5px;" value="${ModelSearch.street}" placeholder="Mời nhập tên Đường !!">--%>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xs-4">
                                        <label for="">Số Tầng Hầm</label>
                                        <form:input  class="form-control"   style="border-radius: 5px;"  placeholder="0" path="numberofbasement"/>
                                            <%--                                        <input type="number" name="numberOfBasement" class="form-control" style="border-radius: 5px;" value="${ModelSearch.numberOfBasement}" placeholder="0">--%>
                                    </div>
                                    <div class="col-xs-4">
                                        <label for="">Hướng</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="Mời nhập tên Hướng!!" path="direction"/>
                                            <%--                                        <input type="text" name="direction" class="form-control" style="border-radius: 5px;" value="${ModelSearch.direction}" placeholder="Mời nhập Hướng !!">--%>
                                    </div>
                                    <div class="col-xs-4">
                                        <label for="">Hạng</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="0" path="lever"/>
                                            <%--                                        <input type="number" name="lever" class="form-control" style="border-radius: 5px;" value="${ModelSearch.lever}" placeholder="Mời nhập hạng !!">--%>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xs-3">
                                        <label for="">Diện Tích Từ</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="0" path="areaFrom"/>
                                            <%--                                        <input type="number" name="areaFrom" class="form-control" style="border-radius: 5px;" value="${ModelSearch.areaFrom}" placeholder="0">--%>
                                    </div>
                                    <div class="col-xs-3">
                                        <label for="">Diện Tích Đến</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="0" path="areaTo"/>
                                            <%--                                        <input type="number" name="areaTo" class="form-control" style="border-radius: 5px;" value="${ModelSearch.areaTo}" placeholder="0">--%>
                                    </div>
                                    <div class="col-xs-3">
                                        <label for="">Giá Tiền Từ</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="0" path="rentPriceFrom" />
                                            <%--                                        <input type="number" name="rentPriceFrom" class="form-control" style="border-radius: 5px;" value="${ModelSearch.rentPriceFrom}" placeholder="0">--%>
                                    </div>
                                    <div class="col-xs-3">
                                        <label for="">Giá Tiền Đến</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="0" path="rentPriceTo"/>
                                            <%--                                        <input type="number" name="rentPriceTo" class="form-control" style="border-radius: 5px;" value="${ModelSearch.rentPriceTo}" placeholder="0">--%>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xs-4">
                                        <label for="">Tên Quản Lý</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="Mời nhập tên quản lý !!" path="managername"/>
                                            <%--                                        <input type="text" name="managerName" class="form-control" style="border-radius: 5px;" value="${ModelSearch.managerName}" placeholder="Mời nhập tên quản lý !!">--%>
                                    </div>
                                    <div class="col-xs-4">
                                        <label for="">SDT quản lý</label>
                                        <form:input class="form-control"   style="border-radius: 5px;"  placeholder="0123456789" path="managerphone"/>
                                            <%--                                        <input type="number" name="managerPhone" class="form-control" style="border-radius: 5px;" value="${ModelSearch.managerPhone}" placeholder="0123456789">--%>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-6">
                                            ...
                                            <%--                                            <input type="checkbox" class="form-check-input" name="typeCode" value="tang-tret">--%>
                                            <%--                                            <label class="form-check-label">Tầng trệt</label>--%>
                                            <%--                                        </div>--%>
                                            <%--                                        <div class="checkbox-inline">--%>
                                            <%--                                            <input type="checkbox" class="form-check-input" name="typeCode" value="nguyen-can">--%>
                                            <%--                                            <label class="form-check-label">Nguyên Căn</label>--%>
                                            <%--                                        </div>--%>
                                            <%--                                        <div class="checkbox-inline">--%>
                                            <%--                                            <input type="checkbox" class="form-check-input" name="typeCode" value="noi-that">--%>
                                            <%--                                            <label class="form-check-label">Nội Thất</label>--%>
                                            <%--                                        </div>--%>
                                        <form:checkboxes items="${rentype}" path="typeCode"  />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xs-6">
                                        <button type="submit" class="btn btn-sm btn-primary" style="border-radius: 5px; padding: 5px 15px;" id="btnSearchbuilding">Tìm Kiếm</button>
                                    </div>
                                </div>
            ...
            <div class="pull-right" id="hovers">
                <security:authorize access="hasRole('MANAGER')">
                    <button class="btn btn-app btn-danger btn-sm" id="btnDeleteBuildings">
    ...
    <div class="col-xs-12">
        <div class="table-responsive">
            <display:table name="buildings" cellspacing="0" cellpadding="0"
                ...
                <display:column headerClass="text-left" property="nameBuilding" title="Tên Toà Nhà"/>
                ...
                <display:column headerClass="text-left" property="empty_area" title="D.T.Trống"/>
                <display:column headerClass="text-left" property="rental_area" title="D.T.Thuê"/>
                ...
                <display:column headerClass="text-left" property="brokerage_fee" title="Phí Môi Giới"/>
                                    ...
                                    <security:authorize access="hasRole('MANAGER')">
                                      <button
                                        ...
                                        <button style="background-color: lightblue; border-radius: 5px;"
                                                title="Giao Toà Nhà " onclick="AssỉngmentBuilding(${item.id})" id="btnAssigmentBuilding">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="modal fade" id="AssỉngmentBuildingModdal">
        ...
        <div class="modal-content rounded-3 shadow-lg" style="border: none; background-color: #f8f9fa;">
            ...
            <div class="modal-footer flex-nowrap p-0">
                ...
                <button type="button"
                        ...
                        style="background-color: #dc3545;" id="btn-Confirm" onclick="ConfirmDeleteBuilding()" >
                ...
                <button type="button" class="btn btn-lg btn-secondary fs-6 text-dark col-6 py-3 m-0 rounded-0"
                        data-bs-dismiss="modal" style="background-color: #6c757d;" id="btn-Cancel" onclick="CancelDeleteBuilding()">
                    Không chắc
                </button>
            </div>
        </div>
...
<%--    thông báo xoà--%>
    ...
    <script>
        ...
        function AssỉngmentBuilding(buildingid) {
        ...
        function AssỉngmentDeleteBuilding() {
            $('#modalChoice').modal();
        }


        function CancelDeleteBuilding() {
            buildingIdToDelete = null; // Đặt lại biến
        ...
        $('#btnDeleteBuildings').click(function (e) {
            ...
            if (buildingIds.length <= 0) {
                ...
                buildingIdToDelete = buildingIds;
        ...
        function ConfirmDeleteBuilding() {
            if (buildingIdToDelete !== null) {
                console.log("Xóa tòa nhà với ID: " + buildingIdToDelete);
                btnDeleteBuildings(buildingIdToDelete);
            }
            $('#modalChoice').modal('hide');
        }

        // Hàm xử lý xóa tòa nhà
        function btnDeleteBuildings(data) {
            $.ajax({
                url: "/api/buildings/" + data,
                type: "DELETE",
                dataType: 'text',
                success: function(result) {
                    console.log("Tòa nhà đã được xóa thành công");
        ...
        function inFormationSucces(){
            ...
            $('#inFormationSucces').on('hidden.bs.modal', function () {
                document.getElementById("AssỉngmentBuildingModdal").submit(); // Submit form
            });
        }
        ...
        $('#save').click(function (e){
            ...
            json['staffs'] = staffs;
            UpdataAssigmentBuilding(json);

        });

        function UpdataAssigmentBuilding(json){
            $.ajax({
