...
<div class="main-content">
    ...
    <div class="pull-right tableTools-container">
        <div class="dt-buttons btn-overlap btn-group">
            <!-- Add User Button -->
            <a href="signup" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" data-toggle="tooltip" title="Thêm người dùng">
                <span>
                    <i class="fa fa-plus-circle bigger-110 purple"></i> Đăng ký
                </span>
            </a>

            <!-- Delete Button -->
            <button id="btnDelete" type="button" disabled class="dt-button buttons-html5 btn btn-white btn-primary btn-bold" data-toggle="tooltip" title="Xóa bài viết" onclick="warningBeforeDelete()">
                <span>
