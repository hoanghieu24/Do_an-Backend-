...
<div class="page-wrapper">
    ...
    <div class="intro text-center mb-5">
        <div class="title-page">HOD AI</div>
        <div class="row">
            <div class="col-xs-12 a-left">
                <ul class="desc-intro">
                    ...
                    <li class="intro-item"><span>HOD AI</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<%--        <img src="https://d34zoy7mey8f6f.cloudfront.net/article_avatar/1577441826.jpg" height="700px" width="1100px" alt="" style="margin-left: 450px; margin-top: 60px;">--%>
