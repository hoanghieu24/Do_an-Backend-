...
<div class="page-wrapper">
    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="product1 vip">
                                    <div class="product1-image new" style="background-image: url('https://tch123.cdn.static123.com/images/thumbs/900x600/fit/2024/04/11/cho-thue-can-ho-chung-cu-vinhomes-central-park_1712819242.jpg');"></div>

                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Căn hộ chung cư tại Vinhome Central Park</a>
                                        </div>
                                        <span class="product1-conntent-title">Vinhome Central Park tọa lạc tại khu vực trung tâm,
                            mang đến không gian sống đẳng cấp và tiện nghi với các dịch vụ hiện đại.
                        </span>
                                        <ul class="product1-conntent-list">
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>Số 208 Nguyễn Hữu Cảnh</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-building"></i>
                                                <span>Loại BĐS: Căn hộ cao cấp</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                    ...
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">3,2 Tỷ</span>
                                        <button class="product1-footer-detail"><a href="https://thuecanho123.com/cho-thue-can-ho-chung-cu-vinhomes-central-park.html" style="color:#fff">Xem chi tiết</a></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="product1 hot">
                                    <div class="product2-image new" style="background-image: url('https://vinhomesland.vn/wp-content/uploads/2019/05/vinhomes-times-city.jpg');"></div>
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Nhà phố tại Times City</a>
                                        </div>
                                        <span class="product1-conntent-title">Times City cung cấp hệ thống nhà phố sang trọng với thiết kế hiện đại,
                            đáp ứng nhu cầu sống tiện nghi của cư dân.
                        </span>
                                        <ul class="product1-conntent-list">
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>Số 458 Minh Khai</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-building"></i>
                                                <span>Loại BĐS: Nhà phố</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-earth-asia"></i>
                                                <span>Diện tích: 70m2 - 150m2</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">6,5 Tỷ</span>
                                        <button class="product1-footer-detail"><a href="https://vinhomesland.vn/vinhomes-times-city/" style="color:#fff">Xem chi tiết</a></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="product1 vip">
                                    <div class="product3-image new" style="background-image: url('https://saigon-ecogreen.vn/wp-content/uploads/2020/04/khu-biet-thu-chateau-nam-vien-phu-my-hung-3.jpg');"></div>
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Biệt thự tại Phú Mỹ Hưng</a>
                                        </div>
                                        <span class="product1-conntent-title">Biệt thự Phú Mỹ Hưng với không gian xanh mát, yên bình,
                            mang lại cuộc sống đẳng cấp và gần gũi với thiên nhiên.
                        </span>
                                        <ul class="product1-conntent-list">
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>Số 50 Nguyễn Lương Bằng</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-building"></i>
                                                <span>Loại BĐS: Biệt thự</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-earth-asia"></i>
                                                <span>Diện tích: 200m2 - 400m2</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">15 Tỷ</span>
                                        <button class="product1-footer-detail"><a href="https://saigon-ecogreen.vn/can-canh-nhung-khu-biet-thu-sieu-dep-tai-phu-my-hung-quan-7/" style="color:#fff">Xem chi tiết</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="content1 justify-content-center">
                        <div class="row">
                            <!-- Sản phẩm 1 -->
                            <div class="col-12 col-md-3">
                                <div class="product1 news">
                                    <div class="product1-image new" style="background-image: url('https://greenhouseagency.com.vn/wp-content/uploads/2022/05/can-ho-landmark-81-02.jpg');"></div>
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Căn hộ cao cấp tại Landmark 81</a>
                                        </div>
                                        <span class="product1-conntent-title">Landmark 81 mang đến không gian sống hiện đại với đầy đủ tiện nghi cao cấp.</span>
                                        <ul class="product1-conntent-list">
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>Số 208 Nguyễn Hữu Cảnh</span>
                                            ...
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-earth-asia"></i>
                                                <span>Diện tích: 55m2 - 120m2</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">4 Tỷ</span>
                                        <button class="product1-footer-detail"><a href="https://example.com/landmark-81" style="color:#fff">Xem chi tiết</a></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="product1 news">
                                    <div class="product2-image new" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSk0xsI3vFJbeYrTmuKyMPEZk6q7-nY9oyA4g&s');"></div>
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Biệt thự tại Palm City</a>
                                        </div>
                                        <span class="product1-conntent-title">Palm City cung cấp những căn biệt thự sang trọng giữa lòng thành phố.</span>
                                        <ul class="product1-conntent-list">
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>Số 15 Mai Chí Thọ</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-building"></i>
                                                <span>Loại BĐS: Biệt thự</span>
                                            ...
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-earth-asia"></i>
                                                <span>Diện tích: 180m2 - 400m2</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">12 Tỷ</span>
                                        <button class="product1-footer-detail"><a href="https://example.com/palm-city" style="color:#fff">Xem chi tiết</a></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="product1 news">
                                    <div class="product3-image new" style="background-image: url('https://saigon-ecogreen.com.vn/uploads/noidung/images/sodo/tong-quan-du-an-can-ho-ecogreen-saigon.jpg');"></div>
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Nhà phố tại Eco Green</a>
                                        </div>
                                        <span class="product1-conntent-title">Eco Green mang lại không gian sống xanh và gần gũi với thiên nhiên.</span>
                                        <ul class="product1-conntent-list">
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>Số 102 Đường Nguyễn Văn Linh</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-building"></i>
                                                <span>Loại BĐS: Nhà phố</span>
                                            ...
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-earth-asia"></i>
                                                <span>Diện tích: 90m2 - 150m2</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">8 Tỷ</span>
                                        <button class="product1-footer-detail"><a href="https://example.com/eco-green" style="color:#fff">Xem chi tiết</a></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="product1 news">
                                    <div class="product3-image new" style="background-image: url('https://www.dqmcorp.vn/Data/Sites/1/News/31/1.vlcsnap-9340-06-14-20h22m29s838-s.jpg');"></div>
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Căn hộ tại Sala City</a>
                                        </div>
                                        <span class="product1-conntent-title">Sala City là khu căn hộ cao cấp, cung cấp không gian sống lý tưởng.</span>
                                        <ul class="product1-conntent-list">
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>Số 50 Nguyễn Cơ Thạch</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-building"></i>
                                                <span>Loại BĐS: Căn hộ cao cấp</span>
                                            ...
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-earth-asia"></i>
                                                <span>Diện tích: 60m2 - 120m2</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">5,5 Tỷ</span>
                                        <button class="product1-footer-detail"><a href="https://example.com/sala-city" style="color:#fff">Xem chi tiết</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="content3">
            <div class="container">
                <div class="text-center">
                    <a class="content3-title" href="">Bất động sản xem nhiều nhất</a>
                </div>
                <div class="container">
                    <div class="content1 justify-content-center">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="product1 hot">
                                    <div class="product1-image " style="background-image: url('https://tch123.cdn.static123.com/images/thumbs/900x600/fit/2024/04/11/cho-thue-can-ho-chung-cu-vinhomes-central-park_1712819242.jpg');"></div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="product1 hot">
                                    <div class="product2-image " style="background-image: url('https://vinhomesland.vn/wp-content/uploads/2019/05/vinhomes-times-city.jpg');"></div>
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Nhà phố tại Times City</a>
                                        </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="product1 hot">
                                    <div class="product1-image " style="background-image: url('https://greenhouseagency.com.vn/wp-content/uploads/2022/05/can-ho-landmark-81-02.jpg');"></div>
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Căn hộ cao cấp tại Landmark 81</a>
                                        </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="product1 hot">
                                    <div class="product2-image " style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSk0xsI3vFJbeYrTmuKyMPEZk6q7-nY9oyA4g&s');"></div>
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Biệt thự tại Palm City</a>
                                        </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="top-footer text-center mt-0">
                    <div class="logo logo-footer pt-5">
                        ...
                        <p class="desc-logo-footer mt-3">Với hơn 10 năm kinh nghiệm, HBOLand tự hào là sàn
                            mua
            ...
            <div class="bottom-footer-2">
                <div class="text-center desc-bottom-footer-2">@ Bản quyền thuộc về HOD Team |
                    Cung cấp bởi <a class="a-text group-name" href="#">HODTeam</a></div>
            </div>
        </footer>
    </div>
</div>
