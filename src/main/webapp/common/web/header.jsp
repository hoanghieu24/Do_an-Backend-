	...
	<%--</div>--%>
		...
		<div class="row navbar">
			<div class="col-12 col-md-3">
				<div class="logo">
					<a href="">
						<img src="https://scontent.xx.fbcdn.net/v/t1.15752-9/462645435_515533798171480_1367675724125360897_n.png?_nc_cat=102&ccb=1-7&_nc_sid=0024fc&_nc_ohc=VqLiKpsMJIoQ7kNvgEop-sd&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=scontent.xx&oh=03_Q7cD1gED_HQOXnp2ThySwI5Ezcxikct9C_3D_9KYcmM9sVj5FA&oe=678B2F03"
			...
			<div class="col-12 col-md-6">
				<div class="item-menu">
					<div class="nav nav1">
						...
						<div class="nav-item p-2">
							<a href='<c:url value='/bot-chat'/>'>
								<%--<span>Liên hệ</span>--%>
									<span style="color: var(--primary-color);">HOD AI</span>
							</a>
						</div>
					</div>
				</div>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<security:authorize access = "isAnonymous()">
						<li class><a class="nav-link" href="<c:url value='/login'/>">Đăng nhập</a></li>
						<li class="nav-item"><a href="signup" class="nav-link" >Đăng ký</a></li>
					</security:authorize>
					<security:authorize access = "isAuthenticated()">
						<li class="nav-item"><a class="nav-link" href="#"> Xin chào <%=SecurityUtils.getPrincipal().getUsername()%></a></li>
						<li class="nav-item"><a class="nav-link" href="<c:url value='/logout'/>">Thoát</a></li>
